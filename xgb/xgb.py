...
feature_columns_to_use = ['contributors_num','is_fork','use_CI','ci_num'] # succeed Tuned 0.760245 Default: 0.759233
# feature_columns_to_use = ['contributors_num','is_fork','use_CI']
# feature_columns_to_use = ['contributors_num','is_fork']
...
Model Report
Accuracy :0.7509
AUC Score (Train): 0.730633
AUC Score (Test): 0.651228
'''
estimators_num = 3
...
# {'max_depth': 4} 0.6793842587516642
...
Model Report
Accuracy :0.7471
AUC Score (Train): 0.732737
AUC Score (Test): 0.651025
'''
...
# {'colsample_bytree': 0.55, 'subsample': 0.8} 0.7105486377598524
...
Model Report
Accuracy :0.7506
AUC Score (Train): 0.744837
AUC Score (Test): 0.653050
'''
...
Model Report
Accuracy :0.7466
AUC Score (Train): 0.736207
AUC Score (Test): 0.647571
'''
