...
csvfile1 = open("Test/Company_repo"+time.strftime("%Y-%m %H:%M", time.localtime())+".csv","a")
csvfile2 = open("Test/Company_commits"+time.strftime("%Y-%m %H:%M", time.localtime())+".csv","a")
